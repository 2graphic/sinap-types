...
describe("Subtype", () => {
    ...
    describe("Simple Object", () => {
        it("identity", () => {
            const obj1 = new Type.SimpleObject("Obj1", new Map([["a", new Type.Literal(4)]]));
            expect(Type.isSubtype(obj1, obj1)).to.be.true;
        });
        it("recursive 1", () => {
            const obj1 = new Type.SimpleObject("Obj1", new Map([["a", new Type.Literal(4)]]));
            const obj2 = new Type.SimpleObject("Obj2", new Map([["a", new Type.Literal(4)]]), obj1);
        ...
        it("recursive 2", () => {
            const obj1 = new Type.SimpleObject("Obj1", new Map([["a", new Type.Literal(4)]]));
            const obj2 = new Type.SimpleObject("Obj2", new Map([["a", new Type.Literal(4)]]), obj1);
            const obj3 = new Type.SimpleObject("Obj3", new Map([["a", new Type.Literal(4)]]), obj2);
    ...
    describe("Intersection", () => {
        const t1 = new Type.SimpleObject("Obj1", new Map());
        const t2 = new Type.SimpleObject("Obj2", new Map());
        const t3 = new Type.SimpleObject("Obj3", new Map());
        const t4 = new Type.SimpleObject("Obj4", new Map());
        const t11 = new Type.SimpleObject("Obj11", new Map(), t1);
...
describe("util", () => {
    it("mapEquivalent", () => {
        expect(Type.mapEquivalent(new Map([["a", "b"]]), new Map([["a", "b"]]), (a, b) => a === b)).to.be.true;
        expect(Type.mapEquivalent(new Map([]), new Map([["a", "b"]]), (a, b) => a === b)).to.be.false;
        expect(Type.mapEquivalent(new Map([["a", "b"]]), new Map([]), (a, b) => a === b)).to.be.false;
        expect(Type.mapEquivalent(new Map([["a", "b"], ['c', 'd']]), new Map([["a", "b"], ['c', 'd']]), (a, b) => a === b)).to.be.true;
        expect(Type.mapEquivalent(new Map([["a", "b"], ['c', 'd']]), new Map([["a", "b"], ['c', 'e']]), (a, b) => a === b)).to.be.false;
        expect(Type.mapEquivalent(new Map([["a", "b"], ['c', 'd']]), new Map([["a", "b"]]), (a, b) => a === b)).to.be.false;
        expect(Type.mapEquivalent(new Map([["a", 7], ['c', 14]]), new Map([["a", 18], ['c', 15]]), (a, b) => a < b)).to.be.true;
        expect(Type.mapEquivalent(new Map([["a", 7], ['c', 14]]), new Map([["a", 18], ['c', 13]]), (a, b) => a < b)).to.be.false;
    });
    it("setEquivalent", () => {
        expect(Type.setEquivalent(new Set([1, 2, 3]), new Set([4, 5, 6]))).to.be.false;
        expect(Type.setEquivalent(new Set([1, 2, 3]), new Set([3, 1, 2]))).to.be.true;
        expect(Type.setEquivalent(new Set([1, 2]), new Set([3, 1, 2]))).to.be.false;
        expect(Type.setEquivalent(new Set([2, 3, 1]), new Set([3, 1, 2]))).to.be.true;
        expect(Type.setEquivalent(new Set([1, 2]), new Set())).to.be.false;
    });
});